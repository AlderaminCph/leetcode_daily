...
>>> Solution().predictPartyVictory(senate = "RD")
'Radiant'
...
>>> Solution().predictPartyVictory(senate = "RDD")
'Dire'
...
class Solution:
    def predictPartyVictory(self, senate: str) -> str:
        ...
        total_length = len(senate)

        while radiant_queue and dire_queue:
            if radiant_queue[0] < dire_queue[0]:  # taking participance in next round
                radiant_queue.append(radiant_queue[0] + total_length)
            else:
                dire_queue.append(dire_queue[0] + total_length)
